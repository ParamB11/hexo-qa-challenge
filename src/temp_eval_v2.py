...
if __name__ == "__main__":
    ...
    # predictions_path = "data/result_base_val.jsonl"
    # ground_truth_path = "datasheet-qa-challenge/dataset/val.jsonl"
    # predictions_path = "data/trial_hybrid_test.jsonl"
    predictions_path = "data/trial_gemini_test.jsonl"
    ground_truth_path = "datasheet-qa-challenge/evaluation_key (instructor only)/test_ground_truth.jsonl"
